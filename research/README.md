...
- [`experiments/2026-07-21-cloudflare-private-staging.md`](experiments/2026-07-21-cloudflare-private-staging.md) — Workers Paid entitlement, route-free disabled deployment, Access header-presence vulnerability and JWT correction, narrow one-time-PIN staging policy, interactive origin-verification secrets, and remaining endpoint-before-Compiler gates
