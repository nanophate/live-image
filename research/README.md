...
- [`experiments/2026-07-21-cloudflare-private-staging.md`](experiments/2026-07-21-cloudflare-private-staging.md) — Workers Paid entitlement, route-free disabled first deployment, private registry image evidence, Access header-presence vulnerability, RS256/issuer/AUD/expiry correction, and remaining Access-before-route rollout gates
