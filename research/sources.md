...
- [anime-face-detector on PyPI](https://pypi.org/project/anime-face-detector/) —
  0.1.0 release metadata and dependency expectations
- [YOLOv3 weight model card](https://huggingface.co/hysts/anime-face-detector-yolov3) —
  intended use and weight license
- [HRNetV2 weight model card](https://huggingface.co/hysts/anime-face-detector-hrnetv2) —
  28-point landmark weight license and provenance disclaimer
- [MediaPipe repository](https://github.com/google-ai-edge/mediapipe) — license,
  on-device input processing and current metrics privacy notice
- [MediaPipe Face Landmarker](https://ai.google.dev/edge/mediapipe/solutions/vision/face_landmarker) — task result surface

## Related work

- [Talking Head Anime 3 demo](https://github.com/pkhungurn/talking-head-anime-3-demo)
- [Talking Head Anime 4 paper](https://arxiv.org/abs/2311.17409)
- [Talking Head Anime 4 demo](https://github.com/pkhungurn/talking-head-anime-4-demo)
- [First Order Motion Model paper](https://arxiv.org/abs/2003.00196)
- [First Order Motion Model code](https://github.com/AliaksandrSiarohin/first-order-model)
- [Thin-Plate Spline Motion Model paper](https://arxiv.org/abs/2203.14367)
...
- [Meta Animated Drawings](https://github.com/facebookresearch/AnimatedDrawings)
